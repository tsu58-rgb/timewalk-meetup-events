...
final class TWJ_Neighborhood_Card_Presentation_Module {
    ...
    public function migrate_koenji_labels() {
        ...
        update_post_meta(self::KOENJI_POST_ID, '_twj_nh_municipality_display_en', 'Suginami ward');
    ...
    private function municipality_map() {
        return array(
            'Chiyoda City' => array('Chiyoda ward', '千代田区'),
            'Chuo City' => array('Chuo ward', '中央区'),
            'Minato City' => array('Minato ward', '港区'),
            'Shinjuku City' => array('Shinjuku ward', '新宿区'),
            'Bunkyo City' => array('Bunkyo ward', '文京区'),
            'Taito City' => array('Taito ward', '台東区'),
            'Sumida City' => array('Sumida ward', '墨田区'),
            'Koto City' => array('Koto ward', '江東区'),
            'Shinagawa City' => array('Shinagawa ward', '品川区'),
            'Meguro City' => array('Meguro ward', '目黒区'),
            'Ota City' => array('Ota ward', '大田区'),
            'Setagaya City' => array('Setagaya ward', '世田谷区'),
            'Shibuya City' => array('Shibuya ward', '渋谷区'),
            'Nakano City' => array('Nakano ward', '中野区'),
            'Suginami City' => array('Suginami ward', '杉並区'),
            'Toshima City' => array('Toshima ward', '豊島区'),
            'Kita City' => array('Kita ward', '北区'),
            'Arakawa City' => array('Arakawa ward', '荒川区'),
            'Itabashi City' => array('Itabashi ward', '板橋区'),
            'Nerima City' => array('Nerima ward', '練馬区'),
            'Adachi City' => array('Adachi ward', '足立区'),
            'Katsushika City' => array('Katsushika ward', '葛飾区'),
            'Edogawa City' => array('Edogawa ward', '江戸川区'),
        );
    }
    ...
    public function styles() {
        $css = '.twj-nh-grid{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:18px!important;align-items:stretch}.twj-nh-card{display:block!important;overflow:hidden!important;margin:0!important;border:1px solid #e2e7ed!important;border-radius:12px!important;background:#fff!important;box-shadow:0 6px 18px rgba(23,32,51,.06)!important}.twj-nh-card__link{display:flex!important;height:100%!important;flex-direction:column!important;color:inherit!important;text-decoration:none!important}.twj-nh-card__link:hover .twj-nh-card__title{text-decoration:underline}.twj-nh-card__link:focus{outline:3px solid #5aa5c3!important;outline-offset:3px}.twj-nh-card__image{display:block!important;aspect-ratio:16/9!important;overflow:hidden!important}.twj-nh-card__image img{display:block!important;width:100%!important;height:100%!important;max-width:none!important;object-fit:cover!important}.twj-nh-card__body{display:flex!important;flex:1!important;flex-direction:column!important;gap:4px!important;padding:13px 14px 15px!important}.twj-nh-card__title{margin:0!important;color:#0563c1!important;font-size:1.02rem!important;font-weight:700!important;line-height:1.25!important}.twj-nh-card__japanese{margin:0!important;color:#455464!important;font-size:.84rem!important;font-weight:600!important;line-height:1.25!important}.twj-nh-card__description{display:-webkit-box!important;-webkit-box-orient:vertical!important;-webkit-line-clamp:4!important;overflow:hidden!important;margin:4px 0 0!important;color:#455464!important;font-size:.86rem!important;line-height:1.42!important}@media(max-width:900px){.twj-nh-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}}@media(max-width:600px){.twj-nh-grid{grid-template-columns:1fr!important}}';
